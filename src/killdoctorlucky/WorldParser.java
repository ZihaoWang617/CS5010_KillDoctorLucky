...
/**
 * Parses world specification files to create game worlds.
 * Reads the mansion layout from a text file and constructs the corresponding Board.
 */
public class WorldParser {
     ...
     * This allows Doctor Lucky to be initialized with the correct movement sequence.
     */
    public static class WorldData {
         ...
         * 
         * @param board the game board with all rooms and connections
         * @param roomsInOrder the ordered list of rooms as they appear in the specification
         */
        public WorldData(Board board, List<Room> roomsInOrder) {
            this.board = board;
            this.roomsInOrder = roomsInOrder;
        }
    }
    
    /**
     * Determines if two rooms are neighbors (share a wall).
     * Two rooms are neighbors if they share at least one edge.
     */
    ...
    private static class RoomData {
        ...
        RoomData(int row1, int col1, int row2, int col2, String name) {
            this.row1 = row1;
            this.col1 = col1;
            this.row2 = row2;
            this.col2 = col2;
    ...
    private static class ItemData {
        ...
        ItemData(int roomIndex, String name, int damage) {
