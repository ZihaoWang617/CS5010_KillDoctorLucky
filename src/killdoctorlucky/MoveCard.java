...
public class MoveCard extends Card {
   ...
   * @param distance the number of additional rooms this card allows movement
   *                 through
   * @throws IllegalArgumentException if name is null/empty or distance is
   *                                  negative
   */
  ...
  /**
   * Gets the movement distance provided by this card. This value represents
   * additional rooms the player can move through.
   * 
   * @return the number of additional rooms this card allows movement, always
   *         non-negative
   */
  ...
  /**
   * Executes this move card to grant additional movement to the player. The
   * player gains extra movement points equal to this card's move distance.
