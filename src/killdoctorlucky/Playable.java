...
/**
 * Interface for game objects that can be played as cards in the game.
 * Playable objects represent cards that player can execute to affect the game state,
 * such as weapon cards, movement cards, or special ability cards.
 */
public interface Playable {
/**
 * execute this card's effect on the game state.
 * this method is called when a player plays thsi card during their turn.
 * 
