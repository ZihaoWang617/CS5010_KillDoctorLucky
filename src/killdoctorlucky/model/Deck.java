 ...
 * two piles: a draw pile for drawing new cards and a discard pile for used
 * cards. When the draw pile is empty, the discard pile is reshuffled.
 */
public class Deck {
  ...
  /**
   * Creates a new deck and initializes it with all game cards. The deck is
   * automatically shuffled after initialization.
   */
  public Deck() {
  ...
  /**
   * Draws a card from the top of the draw pile. If the draw pile is empty, the
   * discard pile is reshuffled into the draw pile first.
   * 
  ...
  /**
   * Adds a card to the discard pile. Cards are typically discarded after being
   * played by players.
   * 
  ...
  /**
   * Shuffles the draw pile randomly. This method randomizes the order of cards in
   * the draw pile.
   */
  public void shuffle() {
    if (drawPile.isEmpty()) {
  ...
  /**
   * Initializes the deck with all game cards. This creates the standard set of
   * weapon cards, failure cards, move cards, and room cards for the Kill Doctor
   * Lucky game.
   */
   ...
   * This method is called automatically when trying to draw from an empty draw
   * pile.
   */
  ...
  public String toString() {
    return String.format("Deck{drawPile=%d, discardPile=%d}", drawPile.size(), discardPile.size());
  }
}