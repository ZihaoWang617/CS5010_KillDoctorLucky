...
/**
 * Interface for entities that can occupy rooms and interact with the visibility system.
 * Occupants are game objects that have a physical presence in rooms and can potentially
 * be seen by other occupants based on line-of-sight rules and room connections.
 */
public interface Occupant {
   ...
   * Visibility is calculated based on room connections, line-of-sight rules,
   * and the current positions of both occupants on the game board.
