 ...
 * Tests game initialization, player management, turn execution, and win conditions.
 */
public class GameTest {
    ...
    public void setUp() {
        ...
        maxPlayers = Arrays.asList("Alice", "Bob", "Charlie", "David", "Eve", "Frank", "George"); // 7 players (maximum)
        tooFewPlayers = Arrays.asList("Alice", "Bob"); // 2 players (below minimum)
        tooManyPlayers = Arrays.asList("Alice", "Bob", "Charlie", "David", "Eve", "Frank", "George", "Henry"); // 8 players (above maximum)
    }
